...
class CronUtils
{
     ...
     *
     * @param int    $time     时间戳
     * @param string $str_cron corntab的时间计划，如，"0 30 2 * * 1-5"
     *
    ...
    static public function check($time, $str_cron) {
        ...
        $str_cron = str_replace(array('MON','TUE','WED','THU','FRI','SAT','SUN'),array('1','2','3','4','5','6','7'),strtoupper($str_cron));
